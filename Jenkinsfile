    ...
    stages {
        ...
        stage('Deploy to EC2') {
            steps {
                ...
                ssh -i "${PEM_PATH}" -o StrictHostKeyChecking=no ec2-user@${EC2_HOST} "nohup java -jar ${DEPLOY_DIR}/${SERVICE_NAME}.jar --server.port=8085 > ${DEPLOY_DIR}/eureka-server.log 2>&1 &"
